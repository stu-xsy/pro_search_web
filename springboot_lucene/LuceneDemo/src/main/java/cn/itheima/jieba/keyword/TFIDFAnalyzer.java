package cn.itheima.jieba.keyword;
import java.io.*;
...
public class TFIDFAnalyzer
{
    ...
    public List<Keyword> analyze(String content,int topN){
        ...
        if(stopWordsSet==null) {
            ...
            loadStopWords(stopWordsSet, this.getClass().getResourceAsStream(""));
        }
        if(idfMap==null) {
            idfMap=new HashMap<>();
            loadIDFMap(idfMap, this.getClass().getResourceAsStream(""));
        }
    ...
    private void loadStopWords(Set<String> set, InputStream in){
        ...
        try
        {
                ...
                bufr= Files.newBufferedReader(Paths.get("D:\\system-student\\Lucene\\LuceneDemo\\stopwords.txt"), Charset.forName("UTF-8"));
                String line=null;
    ...
    private void loadIDFMap(Map<String,Double> map, InputStream in ){
        ...
        try
        {
            bufr= Files.newBufferedReader(Paths.get("D:\\system-student\\Lucene\\LuceneDemo\\idf.utf8.txt"), Charset.forName("UTF-8"));
            String line=null;
            while((line=bufr.readLine())!=null) {
